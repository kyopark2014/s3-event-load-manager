...
또한, 아래와 같이 SQS(invokation)에 put event가 50개씩 전달된것을 확인할 수 있습니다. 15:48분과 15:49분에 각각 50개가 전달되었고, 이후 나머지 메시지들이 15:51분에 전달되었습니다. 이와같이 Step Functions에 전달되는 전체적인 부하(job)은 1분 간격으로 50이하로 관리할 수 있습니다. 
